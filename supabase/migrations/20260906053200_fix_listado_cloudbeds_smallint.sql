-- HAKU · FIX LISTADO CLOUDBEDS
-- PostgreSQL resolvía los literales 1/0 como integer al llamar internamente
-- haiku_crear_reserva(), cuya firma espera smallint para adultos/ninos/mascotas.
-- Se redefine sólo el RPC de importación con casts explícitos.
...
begin
  ...
  loop
    ...
    v_resultado := public.haiku_crear_reserva(
      ...
      p_adultos => 1::smallint,
      p_ninos => 0::smallint,
      p_mascotas => 0::smallint,
      p_correo_contacto => null::text,
      p_telefono_contacto => null::text,
      p_rut => null::text,
