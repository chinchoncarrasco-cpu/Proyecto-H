-- Los ajustes activos forman parte del precio vigente del cargo. El validador
-- debe limitar las aplicaciones por ese monto ajustado, no por el monto base.
...
begin
  ...
  select c.reserva_id, c.estado, ec.monto_ajustado
