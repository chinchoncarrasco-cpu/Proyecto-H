-- HAKU · LISTADO CLOUDBEDS V2
-- Añade ocupación y contacto opcional al importador de reservas.
-- El flujo sigue siendo SIN PAGOS: Deposito y Saldo Pendiente son sólo informativos.
