...
const casos = [
  ...
  caso(11, 'Sep26!S5', 'AGREGAR CAMA ADICIONAL', S.REAL, ['cama_adicional'], F.ND, ['acción operativa']),
  ...
  caso(17, 'Sep26!AE6', 'Tinaja x confirmar', S.AMBIGUO, ['tinaja'], F.ND, ['pendiente sin prestación concreta'], 'No contiene fecha, hora, duración, acción, cobro ni cortesía; no permite saber si la prestación existe.'),
  ...
  caso(31, 'Sep26!K9', '1 hora de tinaja tipo jacuzzi de cortesia por coordinar', S.REAL, ['jacuzzi'], F.CORTESIA, ['duración', 'concepto específico', 'cortesía', 'coordinación']),
  ...
  caso(48, 'Sep26!DC11', '+ 1 HORA DE TINAJA CALIENTE DE COORTESIA X COORDINAR.', S.REAL, ['tinaja'], F.CORTESIA, ['duración', 'cortesía', 'coordinación'], 'Conserva la falta ortográfica real COORTESIA.'),
  caso(49, 'Sep26!G12', 'TINAJA 11HRS. DEJAR BATAS', S.REAL, ['tinaja'], F.ND, ['horario', 'acción operativa']),
  caso(50, 'Sep26!O12', 'tinaja por coordinar', S.REAL, ['tinaja'], F.ND, ['coordinación operativa']),
  ...
  caso(60, 'Sep26!AB14', 'TINAJA X COORDINAR DEJAR BATAS', S.REAL, ['tinaja'], F.ND, ['coordinación', 'acción operativa']),
