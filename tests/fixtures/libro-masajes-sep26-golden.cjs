module.exports = Object.freeze([
  {
    celda: 'Sep26!C3',
    texto: '1 masaje reljante de 60 min simultaneo con Mónica y Josefina a las 19hrs y 1 descontracturante de 60 min. Masajes por pagar',
    unidades: [
      { tipo: 'terapeutico', duracion_minutos: 60, cantidad: 1, hora: '19:00', simultaneo: true, profesionales: ['Mónica', 'Josefina'], asignacion_profesional: null, intencion_financiera: 'COBRABLE', marcadores_distribucion: [] },
      { tipo: 'descontracturante', duracion_minutos: 60, cantidad: 1, hora: '19:00', simultaneo: true, profesionales: ['Mónica', 'Josefina'], asignacion_profesional: null, intencion_financiera: 'COBRABLE', marcadores_distribucion: [] }
    ]
  },
  {
    celda: 'Sep26!CU5',
    texto: '2 masaje  de 1 hora confirmado con Josefina mellado y Mónica desde las 18 hrs por pagar',
    unidades: [
      { tipo: null, duracion_minutos: 60, cantidad: 2, hora: '18:00', simultaneo: false, profesionales: ['Josefina Mellado', 'Mónica'], asignacion_profesional: null, intencion_financiera: 'COBRABLE', marcadores_distribucion: [] }
    ]
  },
  {
    celda: 'Sep26!BO7',
  ...
  {
    celda: 'Sep26!AY10',
    texto: '2 MASAJES RELAJANTES DE 30 MINUTOS C/D CON MONICA X PAGAR (13-09-26)',
    unidades: [
      { tipo: 'terapeutico', duracion_minutos: 30, cantidad: 2, hora: null, simultaneo: false, profesionales: ['Mónica'], asignacion_profesional: null, intencion_financiera: 'COBRABLE', marcadores_distribucion: ['C/D'] }
    ]
  },
  {
    celda: 'Sep26!BS10',
